...
# Main
#====================================================================================
write-diagprogress -activity $LocalizedStrings.RC_UnknownBlueScreen_Running

$errorcode = $bugCheckEvents[0].ErrorCode
$blueScreenDateTime = $bugCheckEvents[0].TimeCreated

Update-DiagRootcause -ID RC_UnknownBlueScreen -Detected $true -iid $errorcode -Parameter @{'errorCode'= $errorcode; 'blueScreenDateTime'= $blueScreenDateTime}
