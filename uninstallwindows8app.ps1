param([string]$AppName = "", [string]$PackageFullName = "")

#validate arg
if($AppName -ne "")
{
    #do not have the package full name, use the app name
    Get-AppxPackage *$AppName*|Remove-AppxPackage -ev err
}

if($PackageFullName -ne "")
{
    # use the package full name to uninstall
    Remove-AppxPackage -package $PackageFullName -ev err    
}

if($err -ne $null)
{    
    $host.SetShouldExit($error[0].Exception.InnerException.HResult)
    exit
}
# SIG # Begin signature block
# MIIabgYJKoZIhvcNAQcCoIIaXzCCGlsCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUAzwY9z5hajL986zUkb3sxeL3
# bqmgghU2MIIEqTCCA5GgAwIBAgITMwAAAIhZDjxRH+JqZwABAAAAiDANBgkqhkiG
...
# +i+ePy5VFmvJE6P9MYIEojCCBJ4CAQEwgZAweTELMAkGA1UEBhMCVVMxEzARBgNV
# BAgTCldhc2hpbmd0b24xEDAOBgNVBAcTB1JlZG1vbmQxHjAcBgNVBAoTFU1pY3Jv
# c29mdCBDb3Jwb3JhdGlvbjEjMCEGA1UEAxMaTWljcm9zb2Z0IENvZGUgU2lnbmlu
# ZyBQQ0ECEzMAAACIWQ48UR/iamcAAQAAAIgwCQYFKw4DAhoFAKCBxDAZBgkqhkiG
# 9w0BCQMxDAYKKwYBBAGCNwIBBDAcBgorBgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIB
# FTAjBgkqhkiG9w0BCQQxFgQUiqyNXdPZyUJm94g+9tAkiqhXYtAwZAYKKwYBBAGC
# NwIBDDFWMFSgLIAqAEMAbwBuAGYAaQBnAHUAcgBhAHQAaQBvAG4AIABNAGEAbgBh
# AGcAZQByoSSAImh0dHA6Ly93d3cubWljcm9zb2Z0LmNvbS9zbXNlcnZlci8wDQYJ
# KoZIhvcNAQEBBQAEggEAjO+6XVfuu2dLD2k5PSPXUsPTw/iriAvrmaLI54MGqN2V
# zuWiPUfjiIvZjrRPxgTqG4ACzzpc0xNAT02sbBCHhiszAeU/ypkuQMwYISqHMprc
# gAWhQRJ29EKKlO1E2jsdB9unjJO19t82f14QTYAMt8PAmjnlPSNnwk8/myez15UG
# ccCfcmjJie+Q8FGKvXuBKIvykznkI3Ogi+P1M4JK524+rsNjOfedYE7dQNPK0GLL
# GYbcBrY5iVQ6DAbc9mn4wY63F3Rvoxp1ekY+yVJUH6ljx0YhdDotrBUGshFw2oA0
# 6+SXPc0oKR6vCwquYFkoRzyCGVhfGaE5VWMbVMEUUqGCAh8wggIbBgkqhkiG9w0B
...
# KoZIhvcNAQkFMQ8XDTEyMDkwNjAyMTMyOFowIwYJKoZIhvcNAQkEMRYEFIPuiJ/G
# eF4lMdGNcSaXvkv7iJB0MA0GCSqGSIb3DQEBBQUABIIBAJXYG1jL+0XWa4jhl7he
# HXGMyg7wRT0qNcDwS3kqrAUBuw87smiGcyaOKG/CB9FD+XuYInKJR48hIOs3trl+
# YvgQ0DxyOZtNMLKFsY6Yj1GQMpPyb9UQXyiHSjYSIL5Zie7bi0k9dosUvNkqQMYS
# OZu9E6UOaCO6Z1atBhaOPiqbcy/oTN3Qn045kKiPRqZzRbF1cwD8C+V/xX70PdHg
# SG652ruXptraCvMNpKsgGHakYNatJh35MgIOqskwVyIs1V8+a8RiJnAw9IVjC6ZA
# MxSDnrFxnOz+XHtvApb0PRejM55Npq8HnX9HyGyynCMVwQy6zXBunUaXFtwq8wm4
# hcI=
