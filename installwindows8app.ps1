param([string]$AppPath = "", [string[]]$DependencyPath = "")
...
if($AppPath -ne "")
{
    ...
    {
        Add-AppxPackage -path $AppPath -DependencyPath $DependencyPath -ev err        
    }
    else
    {
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUOxuB03LzJPJG7GQ0u+tuhSN4
# d/ugghU2MIIEqTCCA5GgAwIBAgITMwAAAIhZDjxRH+JqZwABAAAAiDANBgkqhkiG
...
# FTAjBgkqhkiG9w0BCQQxFgQUuKIilW+eDjWvcQ2diMVsK6BWzdwwZAYKKwYBBAGC
...
# KoZIhvcNAQEBBQAEggEAA/EJcY3IsLfwUL+MqRE95Lgn7i1mLezvk9EUcLYTYf2/
# Aajh48YlgEMVUyezcMD0zsEcuR2zJEFyoRnf174wT/t1qODQjlm+PSSEoa3KPn7H
# wcJm+9uDWTgoM6BW+uKrIPCqPLLDMxesWjObh9aUzgs5KEHCP9HTnpTdvv4lVM8G
# Hy5MStbXhS1Z7VhkE29fVk7HlmjdIKGV0MV3oDQOwlTQxQyPqzIojeaYuXvKXu/w
# IR0vUqIvMJDVLLtTM0MbNQlCTlZvjIgK1bNvvtLrS6rlH050u1zL6pP5JEhVoq2P
# rwJmtBJ5uFq0xgRYu3YCc+C5G+ZJhuruLTKPzrAYcKGCAh8wggIbBgkqhkiG9w0B
...
# KoZIhvcNAQkFMQ8XDTEyMDkwNjAyMTMyOFowIwYJKoZIhvcNAQkEMRYEFMwDAtx6
# vR0TdV9KJVJ5EOqrKfBYMA0GCSqGSIb3DQEBBQUABIIBAFB/naq+dIguZd7UeHLp
# StPEm5Y6scsrVE/W005sl0YXPNUQ5+3tCvgCjA+uOZYWZfAf7jEMs1WYIVsnjEVk
# cPQ5hA3XuHDwfJIv7ft+c4Q9T/275s7w0NLxMxQuKXazQq4StpunibIqzZf0PSKK
# X50PZSa5QaAVNw2pGruKCNF+Y5JIYbPQMO/UnHHjOfl2hn8/nO2od2ToIqi7520Y
# UzxZZq4GSy2yhYrT6vTNn5FTwjbdxIzm3O106V9/wemRs43TvIccmO8UY+et0+ar
# 3q+XJrZ2V1H/UD5ezdJI0BEfU4+jhTOdFq3h+Fz1fJRh2wI0mwKbkcSr+Jwu6OAp
# xII=
